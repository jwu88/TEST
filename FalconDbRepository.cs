    ...
    public class FalconDbRepository<T>
    {
        ...
        public FalconDbRepository(string reportID = null, string reportName = null)
        {
            try
            {
                if (!string.IsNullOrWhiteSpace(reportID))
                {
                    ...
                    {
                        case "AMReport01":
                            query = ";exec cmdb.spVirtualVPhysicalServers";
                            sessionName = "AMReport1Data";
                            break;
                        case "AMReport02":
                            query = "select * from cmdb.vwOperatingSystemCounts order by ServerCount";
                        ...
                        case "AMReport03":
                            ...
                            break;
                        case "AMReport05":
                            query = "select * from cmdb.vwVirtualServerFunctionByLocation order by FUNC";
                            sessionName = "AMReport5Data";
                            break;
                        case "AMReport07":
                            query = "select * from cmdb.vwVirtualServerTypeByProcCount order by ServerFunction";
                            sessionName = "AMReport7Data";
                            break;
                        case "AMReport07DD":
                            query = "select * from cmdb.vwVirtualServerTypeByProcCountDD order by ServerFunction";
                            sessionName = "AMReport7DDData";
                            break;
                        case "AMReport08":
                            query = "select * from cmdb.vwVirtualServerTypeByMemory order by ServerFunction";
                        ...
                        case "AMReport09":
                            ...
                            break;
                        case "AMReport10":
                            query = "select * from cmdb.vwDatabaseCountsByProduct";
                        ...
                        case "AMReport11":
                            ...
                            break;
                        case "AMReport12":
                            query = "select Location, Type,DBSize as TotalRowSizeMB,DatabaseCount as ServerCnt from cmdb.vwDatabaseSizeByType";
                            sessionName = "AMReport12Data";
                            break;
                        case "AMReport13":
                            query = "select * from cmdb.vwOperatingSystemEOL order by EndOfLifeDT";
                        ...
                        case "OverviewDatabasesCount":
                            query = "select Category, HDC, FRA, AWSUS, AWSEU, GrandTotal, DisplayOrder from cmdb.vwDBInstanceOverview order by DisplayOrder";
                            sessionName = "DatabasesCountData";
                            break;
                        case "OverviewDatabaseServerCount":
                            query = "select Category, HDC, FRA, AWSUS, AWSEU, GrandTotal, DisplayOrder from cmdb.vwDBServerOverview order by DisplayOrder";
                            sessionName = "DatabasesServerCountData";
                            break;
                        case "OverviewOSCount":
                            query = "select Category, HDC, FRA, AWSUS, AWSEU, GrandTotal, DisplayOrder from cmdb.vwOSOverview order by DisplayOrder";
                            sessionName = "OSCountData";
                            break;
                        case "OverviewProductCount":
                            query = "select Category, HDC, FRA, AWSUS, AWSEU, GrandTotal, DisplayOrder from cmdb.vwProductOverview order by DisplayOrder";
            ...
            try
            {
                ...
                if (System.Web.HttpContext.Current.Session[sessionName] == null)
                {
                    var query = PetaPoco.Sql.Builder
                        ...
                        .Append("from cmdb.vwServerListDDCommon slc")
                        .Append("where ServerID in (")
                        .Append("select sf.ServerID")
                        .Append("from cmdb.vwServerFunction sf")
                        .Append("inner join cmdb.vwServerHardware s on sf.ServerID = s.ServerID");
            ...
            try
            {
                ...
                if (System.Web.HttpContext.Current.Session[sessionName] == null)
                {
                    ...
                    var query = PetaPoco.Sql.Builder
                        ...
                        .Append("from cmdb.vwServerListOS os");
        ...
        public List<T> GetServerDDListDb(string reportName, string location, string virt, string db, string version, string reportType, string serverName)
        {
            try
            {
                ...
                logger.Info(typeof(T).Name);
                logger.Info(String.Format(";exec cmdb.spServerDDDb '{0}','{1}','{2}','{3}','{4}','{5}','{6}'", reportName, location, virt, db, version, reportType, serverName));

                if (System.Web.HttpContext.Current.Session[sessionName] == null)
                {
                    result = dbFalcon.Fetch<T>(";exec cmdb.spServerDDDb @0, @1, @2, @3, @4, @5",
        ...
        private string BuildReport03Query()
        {
            try
            {
                StringBuilder query = new StringBuilder()
                    ...
                    .Append("from cmdb.vwServerHardware ")
        ...
        private string BuildReport11Query()
        {
            try
            {
                StringBuilder query = new StringBuilder()
                    ...
                    .Append("from cmdb.vwDatabaseSizes ")
        ...
        private string BuildReport08DDQuery()
        {
            ...
            {
                StringBuilder query = new StringBuilder()
                    .Append("select ServerFunction, HDC, FRA, AWS, count(ServerFunction) as ServerCount ")
                    .Append("from cmdb.vwVirtualServerTypeByMemoryDD ")
                    .Append("group by ServerFunction, HDC, FRA, AWS ")
        ...
        private string BuildReport09Query()
        {
            ...
            {
                StringBuilder query = new StringBuilder()
                    .Append(@"select Location, Virtual, Name as VersionDescription, Version, count(distinct DBName) InstanceCount 
                                from cmdb.vwServerDatabaseDetail 
                                where Name like 'SQL Server%' 
	                                and (isSystemDB = 0 or Name = 'DBAmon')
                                group by Location, Virtual, Name, Version order by Name, Version");
        ...
        private string BuildReport16Query()
        {
            ...
            {
                StringBuilder query = new StringBuilder()
                    .Append("select OSName, EndOfLifeDT, Client as ClientName, RaveURL, RaveVersion, count(RaveURL) as CountOfURL ")
                    .Append("from cmdb.vwRaveEOLDD ")
                    .Append("where EndOfLifeInd = 1 ")
                    .Append("group by OSName, EndOfLifeDT, Client, RaveURL, RaveVersion")
                    ;
        ...
        private string BuildReport17Query()
        {
            try
            {
                StringBuilder query = new StringBuilder()
                    ...
                    //.Append("from cmdb.vwDatabaseServerCounts ")
                    .Append("select Location, Virtual, Name as VersionDescription, Version, count(distinct ServerName) ServerCount ")
                    .Append("from cmdb.vwServerDatabaseDetail ")
                    .Append("where Name like 'SQL Server%' ")
                    .Append("group by Location, Virtual, Name, Version ")
                    .Append("order by Name, Version")
                    ;
        ...
        private string BuildReport18Query()
        {
            ...
            {
                StringBuilder query = new StringBuilder()
                    .Append("select Location, Virtual, Name as VersionDescription, sum(InstanceCount) InstanceCount ")
                    .Append("from cmdb.vwDatabaseCountsByProduct ")
                    .Append("group by Location, Virtual, Name")
                    ;
        ...
        private string BuildReport19Query()
        {
            ...
            {
                StringBuilder query = new StringBuilder()
                    .Append("select Location, Virtual, Name as VersionDescription, sum(ServerCount) ServerCount ")
                    .Append("from cmdb.vwDatabaseServerCounts ")
                    .Append("group by Location, Virtual, Name")
                    ;
        ...
        private string BuildEnvReportQuery(string name)
        {
            try
            {
                StringBuilder query = new StringBuilder()
                    ...
                    .Append("from cmdb.vwEnvironmentList ")
        ...
        private string BuildReport34Query()
        {
            try
            {
                StringBuilder query = new StringBuilder()
                    .Append("select *  ")
                    .Append("from cmdb.vwVMHostCapacity ")
    ...
    public class FalconDbRepository : Controller
    {
        ...
        public List<Application> GetAppplicationList()
        {
            ...
            try
            {
                ...
                {
                    var query = PetaPoco.Sql.Builder
                        .Append("select ApplicationName, HDC, AWSUS, FRA, AWSEU,")
                        .Append("GrandTotal, ReportId")
                        .Append("from cmdb.vwApplications")
            ...
            try
            {
                ...
                if (listName == "clients")
                {
                    query = PetaPoco.Sql.Builder
                        .Append("select distinct Sponsor as ItemText, concat('c', SponsorId) as ItemValue")
                        .Append("from cmdb.vwSiteInfoAll")
                        ;
                    if (!string.IsNullOrWhiteSpace(filter))
                    {
                        if (!exactMatch)
                            query.Append("where Sponsor like '%" + filter + "%'");
                        else
                            query.Append("where Sponsor = @0", filter);
                    }
                ...
                {
                    query = PetaPoco.Sql.Builder
                        .Append("select distinct url as ItemText, ProductId as site_id as ItemValue")
                        .Append("from cmdb.vwSiteInfoAll")
                        ;
                    if (!string.IsNullOrWhiteSpace(filter))
                    {
                ...
                else if (listName == "servers")
                {
                    ...
                    {
                        query.Append("select distinct url as ItemText, concat('u', ProductId) as ItemValue")
                            .Append("from cmdb.vwSiteInfoAll")
                    ...
                    else if (rServer.IsMatch(filter))
                    {
                        query.Append("select distinct s.ServerName as ItemText, concat('s', s.ServerID) as ItemValue")
                            .Append("from cmdb.vwServerHardware s")
                            .Append("where s.ServerName like '%" + filter + "%'");

                        query.Append("union")
                            .Append("select distinct s.ServerName, concat('s', s.ServerID)")
                            .Append("from cmdb.vwAWSInstance aws")
                            .Append("inner join cmdb.vwServerHardware s")
                    ...
                    else
                    {
                        ...
                        query.Append("union")
                            .Append("select distinct url as ItemText, concat('u', ProductId) as ItemValue")
                            .Append("from cmdb.vwSiteInfoAll")
                            ;
                        if (!string.IsNullOrWhiteSpace(filter))
                            query.Append("where url like '%" + filter + "%'");
                        ...
                        query.Append("union")
                            .Append("select distinct Sponsor as ItemText, concat('c', Sponsor) as ItemValue")
                            .Append("from cmdb.vwSiteInfoAll")
                            ;
                        if (!string.IsNullOrWhiteSpace(filter))
                            query.Append("where Sponsor like '%" + filter + "%'");
        ...
        public List<RaveData> GetRaveUrlList(string reportName, string location = null, string env = null, string version = null, string db = null)
        {
            try
            {
                ...
                if (System.Web.HttpContext.Current.Session[sessionName] == null)
                {
                    var query = PetaPoco.Sql.Builder.Append(@"
                                                select ProductId as site_id, Sponsor as clientname, url, 
                                                        RaveVersion, VersionName, dbname, sqlserver, urlloc, datacenter, team, urltype,
	                                                    DatabaseSizeMB as dbsize, PageViews
                                                from cmdb.vwSiteInfo");
                    //.Where("disabled = 0");
            ...
            try
            {
                ...
                if (System.Web.HttpContext.Current.Session[sessionName] == null)
                {
                    var query = PetaPoco.Sql.Builder
                        ...
                        .Append("from cmdb.vwRaveURLHardware")
        ...
        public RaveData GetRaveSiteDetails(int id)
        {
            try
            {
                ...
                {
                    var query = PetaPoco.Sql.Builder
                        .Select("ProductId as site_id, clientname, partner, datacenter, url, RaveVersion, team,")
        ...
        public List<SitePatch> GetRaveSitePatches(int siteId)
        {
            try
            {
                List<SitePatch> result;
                sessionName = string.Format("SitePatches{0}", siteId);

                if (System.Web.HttpContext.Current.Session[sessionName] == null)
                {
                    var query = PetaPoco.Sql.Builder
                        .Append(@"select id, ProductId as site_id, PatchNumber, version, Description, RaveVersion, AppliedBy,
                                    AppServers, WebServers, DateApplied
                                  from cmdb.vwGetSitePatches
                                  where ProductId = @0
                                  order by DateApplied DESC, RaveVersion DESC", siteId);
        ...
        public void GetRaveSitePatches(int id, out List<SitePatch> result, out string error)
        {
            ...
            {
                var query = PetaPoco.Sql.Builder
                    .Select("id, ProductId as site_id, PatchNumber, version, Description, RaveVersion, AppliedBy,")
            ...
            {
                error = "GetRaveSitePatches: " + ex.Message + ex.StackTrace;
            }
        }

        public List<SiteAddon> GetSiteAddons(int siteId)
        {
            try
            {
                List<SiteAddon> result;
                sessionName = string.Format("SiteAddons{0}", siteId);

                if (System.Web.HttpContext.Current.Session[sessionName] == null)
                {
                    var query = PetaPoco.Sql.Builder
                        .Append("select distinct Name")
                        .Append("from cmdb.vwAddons")
                        .Append("where ProductId = @0", siteId);
                    //.OrderBy("name");
        ...
        public void GetSiteAddons(int id, out List<SiteAddon> result, out string error)
        {
            ...
            {
                error = "GetSiteAddons: " + ex.Message + ex.StackTrace;
            }
        }
        ...
        private List<ChildRowKVP> GetEnvNameLinks(string addOnName, string url)
        {
            ...
            var envInfoQuery = PetaPoco.Sql.Builder
                ...
                .Append("from cmdb.vwEnvironmentList el")
        ...
        public void GetRaveSiteClientInfo(int id, out List<SiteInfo> result, out string error)
        {
            ...
            {
                error = "GetRaveSiteClientInfo: " + ex.Message + ex.StackTrace;
            }
        }
        ...
        public void GetRaveSiteRaveInfo(int id, out List<SiteInfo> result, out string error)
        {
            ...
            {
                error = "GetRaveSiteRaveInfo: " + ex.Message + ex.StackTrace;
            }
        }
        ...
        public List<ServerListDetails> GetServerListDetails(int id)
        {
            try
            {
                var query = PetaPoco.Sql.Builder
                    ...
                    .Append("from cmdb.vwServerDetailsList")
        ...
        public string GetURL(int siteId)
        {
            try
            {
                string result;

                sessionName = string.Format("URL{0}", siteId);

                if (System.Web.HttpContext.Current.Session[sessionName] == null)
                {
                    //var query = PetaPoco.Sql.Builder.Append(@"select dm.DNSName
                    //                                          from SolutionInstance si
                    //                                            inner join DNSMaster dm on si.PublicIPAddress = dm.IPAddress
                    //                                           where si.SolutionInstanceID = @0
                    //                                            and dm.DNSName not like 'hdcvcl%'", siteId);
                    var query = PetaPoco.Sql.Builder.Append(@"select URL
                                                              from cmdb.vwSiteInfo
                                                              where ProductId = @0
	                                                                and URL not like 'hdcvcl%'", siteId);
        ...
        public List<URLServer> GetURLServerList(int id)
        {
            try
            {
                ...
                {
                    var query = PetaPoco.Sql.Builder
                        .Append("select ProductID as site_id, ServerID, ServerType, ServerName, OSName, MemoryGB, ProcessorCount, URL")
                        .Append("from cmdb.vwURLServers")
                        .Append("where ProductId = @0", id)
        ...
        public void GetURLServerList(int id, out List<URLServer> result, out string error)
        {
            ...
            {
                error = "GetURLServerList: " + ex.Message + ex.StackTrace;
            }
        }
            ...
            try
            {
                ...
                if (System.Web.HttpContext.Current.Session[sessionName] == null)
                {
                    var query = PetaPoco.Sql.Builder
                        ...
                        .Append("FileSystemType, ServerID, CapacityGB, FreeSpaceGB, UsedSpaceGB")
                        .Append("from cmdb.vwServerVolumeInfo")
                        .Append("where ServerID = @0", id);
            ...
            try
            {
                ...
                if (System.Web.HttpContext.Current.Session[sessionName] == null)
                {
                    var query = PetaPoco.Sql.Builder
                        ...
                        .Append("from cmdb.vwServerNICInfo")
                        .Append("where ServerID = @0", id)
                ...
                switch (type)
                {
                    case "envtype":
                        var query = PetaPoco.Sql.Builder
                            ...
                            .Append("from cmdb.vwEnvironmentTypes")
                    ...
                    case "srvfunction":
                        query = PetaPoco.Sql.Builder
                            ...
                            .Append("from cmdb.vwServerFunction")
                    ...
                    case "dbserver":
                        query = PetaPoco.Sql.Builder
                            ...
                            .Append("from cmdb.vwDbServerDbName")
        ...
        public List<RaveData> GetClientUrls(int id, string version = null)
        {
            try
            {
                ...
                if (System.Web.HttpContext.Current.Session[sessionName] == null)
                {
                    var query = PetaPoco.Sql.Builder.Append(@"SELECT ProductId as site_id, Sponsor as clientname, url, RaveVersion, 
                                                                VersionName, dbname, sqlserver, urlloc, datacenter, team, urltype
                                                               From cmdb.vwSiteInfo
                                                               Where SponsorId = @0", id);
                    if (!string.IsNullOrWhiteSpace(version))
        ...
        public void GetCMPData(string id, out List<CMPData> result, out string error)
        {
            ...
            {
                error = "GetCMPData: " + ex.Message + ex.StackTrace;
            }
        }
        ...
        public List<DropDownItems> GetUrls()
        {
            try
            {
                ...
                {
                    var query = PetaPoco.Sql.Builder
                        .Select("url as ItemText, ProductId as site_id as ItemValue")
                        .From("cmdb.vwSiteInfo")
                        .OrderBy("url");
            ...
            try
            {
                ...
                if (System.Web.HttpContext.Current.Session[sessionName] == null)
                {
                    ...
                    var queryIP = PetaPoco.Sql.Builder
                        ...
                        .Append("from cmdb.fnGetPoolMembersByURL('" + url + "')");
                    ...
                    var queryAL = PetaPoco.Sql.Builder.Append(@"select * from cmdb.vwDNSAll 
                                                            where DNSName = @0
                                                            order by IsCustomerFacing desc", url);

                    var queryPM = PetaPoco.Sql.Builder
                        .Select("PoolMember, PoolMemberIP")
                        .From("cmdb.fnGetPoolMembersByURL('" + url + "')");
        ...
        public void GetNetworkInfo(string url, out NetworkInfo ni, out string error)
        {
            ...
            {
                error = "GetNetworkInfo:" + ex.Message + ex.StackTrace;
            }
        }

        public List<WebServerInfomation> GetWebServerInfo(int siteId)
        {
            try
            {
                var query = PetaPoco.Sql.Builder
                    .Append("select ProductId as SolutionInstanceID, URL, ServerName, Config, RemotingServer, [SSL], CleaningEngine, SessionState")
                    .Append("from cmdb.vwWebServerInformation")
                    .Append("where ProductId = @0", siteId);
        ...
        public void GetWebServerInfo(int id, out List<WebServerInfomation> result, out string error)
        {
            ...
            {
                var query = PetaPoco.Sql.Builder
                    .Append("select ProductId as SolutionInstanceID, URL, ServerName, Config, RemotingServer, [SSL], isnull(CleaningEngine, 'false') as CleaningEngine, SessionState")
                    .Append("from cmdb.vwWebServerInformation")
                    .Append("where ProductId = @0", id);
            ...
            {
                error = "GetWebServerInfo: " + ex.Message + ex.StackTrace;
            }
        }

        public List<AppServerInfomation> GetAppServerInfo(int siteId)
        {
            try
            {
                var query = PetaPoco.Sql.Builder
                    .Append("select ProductId as SolutionInstanceID, URL, ServerName, Config, ServiceName, RemotingServer, isnull(PDF, 'false') as PDF, ")
                    ...
                    .Append("from cmdb.vwAppServerInformation")
                    .Append("where ProductId = @0", siteId);
        ...
        public void GetAppServerInfo(int id, out List<AppServerInfomation> result, out string error)
        {
            ...
            {
                var query = PetaPoco.Sql.Builder
                    .Append("select ProductId as SolutionInstanceID, URL, ServerName, Config, ServiceName, RemotingServer, PDF, DeferredStatusRollups, ClinicalViews,")
            ...
            {
                error = "GetAppServerInfo: " + ex.Message + ex.StackTrace;
            }
        }
        ...
        public List<RaveViewerInfomation> GetRaveViewerInfo(int id)
        {
            ...
            {
                var query = PetaPoco.Sql.Builder
                    .Append("select distinct ProductId as SolutionInstanceID, URL, ServerName, ViewerURL, UniqueName, NULL as Location")
                    .Append("from cmdb.vwRaveViewerInformation")
                    .Append("where ProductId = @0", id);
        ...
        public List<ScriptLastRunDate> GetLastRunDate()
        {
            try
            {
                ...
                reportData = dbFalcon.Fetch<ScriptLastRunDate>("select * from cmdb.vwScriptLastRunDate");
